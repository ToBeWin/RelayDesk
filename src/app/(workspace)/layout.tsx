...
export default async function WorkspaceLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  ...
  return <div className="workspace"><WorkspaceSidebar operatorName={operator.name} isAdmin={operator.role === "admin"} runtimeLabel={runtimeLabel} contentWorkspaceEnabled={config.contentWorkspaceEnabled} /><main className="workspace-main">{children}</main></div>;
}
