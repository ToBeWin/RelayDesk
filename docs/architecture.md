...
RelayDesk is a self-hosted Web Channel for Agent Runtime systems. The web application owns login, operator identity, local message/asset persistence, content records and scheduling. Hermes/OpenClaw owns inference, tools, images, memory and the agent loop.
